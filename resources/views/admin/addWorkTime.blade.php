    ...
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="special-head">
          <h1 class="p-relative">Add WorkTime</h1>
        </div>
        <div class="wrapper">
          <div class="control-products content">
            <div class="holder">
              <form method="POST" action="{{ route('store-worktime') }}">
                @csrf
                <div class="from" >
                ...
                <div class="from">
                  ...
                  <input type="time" name="from" id="from" placeholder="From 00:00" />
                </div>
                <div class="to">
                  <label for="to">To</label>
                  <input type="time" name="to" id="to" placeholder="To 00:00" />
                </div>
