    ...
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="special-head" style="margin-bottom: 20px">
          <h1 class="p-relative">Manage Deleted Areas</h1>
        </div>
        <div class="wrapper d-grid gap-20">
          ...
          <div class="cities-holder d-flex txt-c gap-20 f-wrap">
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">{{ $deletedRecord->area_name }}</span>
              <p style="margin: 0px">{{ $deletedRecord->city->city_name }}</p>
              <div class="btns">
            ...
            @endforeach
            <!--<div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">Almaydan</span>
              <p style="margin: 0px">Damascus</p>
              <div class="btns">
            ...
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">Old Aleppo</span>
              <p style="margin: 0px">Aleppo</p>
              <div class="btns">
                <button style="display: inline-block" class="control-btn edit">
                  <img
                    title="rerstore"
            ...
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">Ibn Rushid</span>
              <p style="margin: 0px">Hama</p>
              <div class="btns">
                <button style="display: inline-block" class="control-btn edit">
                  <img
                    title="restore"
