...
>
  ...
  <span>Logout</span>
      ...
      <div class="content w-full">
        ...
        <div class="special-head" style="margin-bottom: 20px">
          <h1 class="p-relative">Cities</h1>
          <a href="{{ route('add-city') }}" class="btn">+ Add City</a>
        </div>
        <div class="wrapper d-grid gap-20">
          ...
          <div class="cities-holder d-flex txt-c gap-20 f-wrap">
            ...
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">{{ $city->city_name }}</span>
              <div class="btns">
                <a
                  style="display: inline-block"
                  href="{{ route('edit-city', $city->id) }}"
                ...
                onclick="handlePopUp(true,0, {{ $city->id }})"
                >
                <img src="{{ asset('../imgs/bin.png')}}" alt="del" />
                </button>

                <!--<a href="{{ route('delete-city',['id' => $city->id]) }}" style="border: none; background-color: transparent; padding: 0px;">
                <img src="{{ asset('imgs/bin.png') }}" alt="del" />
                </a>-->
          ...
          <div class="overlay" style="display: none">
            <div class="content">
              ...
              <div class="btns">
                <button id="confirmDeleteBtn" class="confirm popup-btn">Yes</button>
  ...
  let deleteId = null; // نخزن فيه ID العنصر المراد حذفه

  function handlePopUp(isShow, elementID, id = null) {
    if (isShow) {
      deleteId = id;
  ...
  confirmDeleteBtn.addEventListener("click", function () {
    if (deleteId) {
      window.location.href = `/city/delete/${deleteId}`;
    }
  });
