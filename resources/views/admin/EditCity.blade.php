    ...
    <div class="page d-flex">
      <div class="sidebar p-20 p-relative">
        <div class="logo-holder">
            <img src="{{ asset('imgs/logo.png') }}" alt="logo" style="width: 30px; height: 30px;" />
      ...
      <div class="content w-full">
        ...
        <div class="head p-15 between-flex">
          ...
          <div class="icons d-flex align-center">
            ...
            <a href="profile.html">
                <img src="{{ asset('../imgs/avatar.png') }}" alt="logo" style="width: 30px; height: 30px;" />
            </a>
          </div>
        </div>
        <!-- End Head -->
        <div class="special-head">
          <h1 class="p-relative">Edit City</h1>
        </div>
        <div class="wrapper">
          <div class="control-products content">
            <div class="holder">
              <form method="post" action="{{ route('update-city',['id' => $city->id]) }} ">
                @csrf
                <div class="name">
