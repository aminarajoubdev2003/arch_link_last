    ...
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="special-head" style="margin-bottom: 20px">
          <h1 class="p-relative">Client</h1>
        </div>
        <div class="wrapper d-grid gap-20">
          <div class="filters" style="justify-content: space-between">
            <div class="filters-holder">
              <label style="color: var(--blue-color)" for="name-search"
                >Name</label
              >
          ...
          <div class="friends-page d-grid gap-20">
            ...
            <div class="friend bg-white rad-6 p-20 p-relative">
              <div class="infos txt-c">
                <img
                  class="rad-half mt-10 mb-10 w-100 h-100"
                  src="{{ Storage::url(str_replace('public/', '', $client->image)) }}"
              ...
              <div class="icons fs-14 p-relative">
                <div class="mb-10">
                  <i class="fa-regular fas fa-globe-asia"></i>
                 <span>{{ $client->area->city->city_name }} - {{ $client->area->area_name}}</span>
                </div>
                <div class="mb-10">
              ...
              <div class="info between-flex fs-13">
                <div class="ballance">
                  <span>Ballance: </span>
                  <span class="c-grey">{{ $client->account}}$</span>
                </div>
                <div>
                  <a
                    class="bg-blue c-white btn-shape"
                    href="{{ route('edit-client' , $client->id )}}"
                    >Edit</a
                  >
                </div>
              </div>
            ...
            <!--<div class="friend bg-white rad-6 p-20 p-relative">
              <div class="infos txt-c">
                ...
                <p class="c-grey fs-13 mt-5 mb-0">Customer</p>
              </div>
              <div class="icons fs-14 p-relative">
                <div class="mb-10">
                  <i class="fa-regular fas fa-globe-asia"></i>
                  <span>Homs,AlHamra</span>
                </div>
                <div class="mb-10">
                  <i class="fa-solid fa-phone"></i>
    ...
    <script>
      ...
      function showCards(
        ...
        for (let i = 0; i < cards.length; i++) {
          cardsHolder.appendChild(cards[i].parentElement);
        }
      }
      let filteredInfos = [];
      ...
      function filterFunc(name, role) {
        if (name == "" && role == "all") {
          ...
          return Array.from(clients).filter((client) =>
            client.children[1].innerHTML.toLowerCase().includes(name)
          );
        } else if (name == "") {
          console.log(12);
          return Array.from(clients).filter((client) =>
            client.children[2].innerHTML.toLowerCase().includes(role)
          );
        }
        return Array.from(clients)
          .filter((client) =>
      ...
      // rating
      const starsHolder = document.querySelectorAll(
        ".wrapper .friends-page .friend .rating"
      );
      for (let i = 0; i < starsHolder.length; i++) {
        const stars = +starsHolder[i].classList[1];
        for (let j = 0; j < 5; j++) {
          if (j < stars) {
            starsHolder[i].innerHTML +=
              '<i class="fa-solid fa-star c-orange fs-13"></i>';
          } else {
            starsHolder[i].innerHTML +=
              '<i class="far fa-star c-orange fs-13"></i>';
          }
        }
      }
      // accordion
