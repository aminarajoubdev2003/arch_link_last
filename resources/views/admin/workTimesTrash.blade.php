    ...
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="special-head" style="margin-bottom: 20px">
          <h1 class="p-relative">Manage Deleted Items</h1>
        </div>
          ...
          <div class="show-products content">
            <table>
              ...
              <tbody>
                ...
                <tr scope="row">
                  <td data-label="Day">{{ $deletedRecord->day }}</td>
                  <td data-label="From">{{ $deletedRecord->from }}</td>
                  <td data-label="To">{{ $deletedRecord->to }}</td>
                  <td data-label="Action">
                    <div class="btns">
                      <button>
                        <a href="{{ route('restore-time', $deletedRecord->id) }}" style="display: inline-block" class="control-btn edit">
                      ...
                      >-->
                        <!-- <i
                          ...
                          style="color: var(--red-color); font-size: 15px"
                        ></i> -->
                        <!--<img title="delete" src="../imgs/bin.png" alt="" />
                      </button>-->
                    </div>
                  </td>
                </tr>
