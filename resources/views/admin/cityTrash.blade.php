  ...
  <body>
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="special-head" style="margin-bottom: 20px">
          <h1 class="p-relative">Manage Deleted Cities</h1>
        </div>
        <div class="wrapper d-grid gap-20">
          ...
          <!-- Cities -->
          <div class="cities-holder d-flex txt-c gap-20 f-wrap">
            @foreach( $deletedRecords as $deletedRecord )
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">{{ $deletedRecord->city_name }}</span>
              <div class="btns">
                <button>
                <a href="{{ route('restore-city', $deletedRecord->id) }}" style="display: inline-block" class="control-btn edit">
                 <img title="restore" src="{{ asset('imgs/restoreIcon.png') }}" alt="restore" />
                </a>
                </button>

                <!--<button style="display: inline-block" class="control-btn edit">
                  <img
                    title="restore"
               ...
               <!-- <button
                ...
                >
                  <img title="delete" src="../imgs/bin.png" alt="del" />
                </button>-->
              </div>
            </div>
            @endforeach
            <!--<div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">Damascus</span>
              <div class="btns">
                <button style="display: inline-block" class="control-btn edit">
                  <img
                    title="restore"
            ...
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">Aleppo</span>
              <div class="btns">
                <button style="display: inline-block" class="control-btn edit">
                  <img
                    title="restore"
            ...
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">Hama</span>
              <div class="btns">
                <button style="display: inline-block" class="control-btn edit">
                  <img
                    title="restore"
    ...
    <script>
      ...
      if (accordionIcon.classList.contains("closed")) {
        accordionIcon.classList.toggle("closed");
        accordionIcon.children[0].className = "arrow 	fas fa-angle-up";
        accordion.children[1].style.display = "block";
      } else {
        accordionIcon.classList.toggle("closed");
        accordionIcon.children[0].className = "arrow 	fas fa-angle-down";
