    ...
    <div class="page d-flex">
      <div class="sidebar p-20 p-relative">
        ...
        <ul>
          ...
          <li>
            ...
            >
              <i class="active fa-solid fas fa-chart-area fa-fw"></i>
              <span>Area</span>
            </a>
          </li>
          <li>
      ...
      <div class="content w-full">
        ...
        <div class="special-head">
          <h1 class="p-relative">Add Area</h1>
        </div>
        <div class="wrapper">
          <div class="control-products content">
            <div class="holder">
              <form method="POST" action="{{ route('store-area') }}">
                @csrf
                <div class="name">
                  <label for="area-name">Area Name</label>
                  <input type="text" id="area-name" name="area_name" placeholder="Area Name" required />
                </div>
                <div class="name">
...
<!--
              <div class="product-image">
                <div class="upload">
                  ...
                  <img src="./imgs/Upload icon.svg" alt="product image" />
                </div>
              </div> -->
