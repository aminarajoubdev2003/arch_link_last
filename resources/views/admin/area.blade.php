...
<html lang="en">
    ...
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="special-head" style="margin-bottom: 20px">
          <h1 class="p-relative">Areas</h1>
          <a href="{{ route('add-area')}}" class="btn">+ Add Area</a>
        </div>
        <div class="wrapper d-grid gap-20">
          ...
          <div class="cities-holder d-flex txt-c gap-20 f-wrap">
            ...
            <div class="box p-20 rad-10 fs-13 c-grey">
              <span class="d-block c-black fw-bold fs-25 mb-5">{{ $area->area_name }}</span>
              <p style="margin: 0px">{{ $area->city->city_name}}</p>
              <div class="btns">
                <a
                  style="display: inline-block"
                  href="{{ route('edit-area', $area->id)}}"
                ...
                class="control-btn delete"
                onclick="handlePopUp(true, 0, {{ $area->id }})"
                >
  ...
  <div class="content">
    ...
    <div class="btns">
      <!-- نضيف id للمنطقة هنا -->
      <a id="confirm-delete-btn" href="#" class="confirm popup-btn">Yes</a>
  ...
  let filteredAreas = [];
  let filteredCities = [];
  const clients = document.querySelectorAll(".wrapper .cities-holder .box");
  const searchInput = document.querySelector(
    ".wrapper .filters .search input"
  );
  const roleSelect = document.querySelector(".wrapper .filters select");
  const clientsHolder = document.querySelector(".wrapper .cities-holder");
  ...
  function filterFunc(name, role) {
    if (name == "" && role == "all") {
      ...
      return Array.from(clients).filter((client) =>
        client.children[0].innerHTML.toLowerCase().includes(name)
      );
    } else if (name == "") {
      return Array.from(clients).filter((client) =>
        client.children[1].innerHTML.toLowerCase().includes(role)
      );
    }
    return Array.from(clients)
      .filter((client) =>
