...
<html lang="en">
          ...
          <div class="show-products content">
            <table>
              ...
              <tbody>
                ...
                <tr scope="row">
                  <td data-label="Day">{{ $time->day }}</td>
                  <td data-label="From">{{ $time->from }}</td>
                  <td data-label="To">{{ $time->to }}</td>
                  <td data-label="Action">
                    <div class="btns">
                      <a href="{{ route('edit-worktime', $time->id)}}" class="control-btn edit">
                    ...
                    <button
                    class="control-btn delete"
                    onclick="handlePopUp(true,0, {{ $time->id }})"
                    >
  ...
  confirmDeleteBtn.addEventListener("click", function () {
    if (deleteId) {
      window.location.href = `/worktime/delete/${deleteId}`;
    }
  });
