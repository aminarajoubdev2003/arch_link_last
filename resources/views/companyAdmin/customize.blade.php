...
<html lang="en">
  ...
  --error-color: #b3261e;
    ...
    rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px; */
      ...
      /* Product */
      .wrapper .content table td .image,
      .wrapper .content table td .image img {
        width: 100px;
      }
      ...
      .overlay.full-screen-img .backdrop {
        width: 100%;
        height: 100%;
        position: fixed;
      }
      .overlay.full-screen-img .content {
        height: auto;
        width: 400px;
        height: 400px;
        padding: 0px;
      ...
      table .image:hover .click-animation {
        height: 100%;
        opacity: 1;
      }
      .loader {
  ...
  <body>
      ...
      <div class="sidebar p-20 p-relative">
        <div class="holder">
          ...
          <ul>
            ...
            <li class="accordion">
              <div
                class="active accordion-holder d-flex align-center fs-14 c-black rad-6 p-10"
              >
                <div class="holder">
        ...
        <div class="head p-15 between-flex">
          ...
          <div class="icons d-flex align-center">
            <span
              ...
              onclick="handleSettingsPopUp(true)"
            >
              ...
              <div class="text">
                ...
                <div class="btns">
                  ...
                  <button
                    ...
                    onclick="handleSettingsPopUp(false)"
                  >
                    Dismiss
                  </button>
                </div>
    ...
    <script>
      ...
      const settingsOverlay = document.querySelector(".overlay.notification");
      function handleSettingsPopUp(isShow) {
        if (isShow) settingsOverlay.style.display = "flex";
      ...
      function sendFinishedOrders() {
        console.log(rows);
        const sentData = Array.from(rows)
          .filter(
            (row) => row.lastElementChild.firstElementChild.checked == true
          )
          .map((row) => {
            // استبدال الـ input بـ span فيه "Sent"
      ...
      const allRows = Array.from(ordersTable.querySelectorAll("tr"));

      function removeNoResultsRow() {
        const noResultsRow = ordersTable.querySelector("tr.no-results");
        if (noResultsRow) {
          noResultsRow.remove();
        }
      }
      ...
      function filterOrders(value) {
        removeNoResultsRow(); // دائماً نحاول نحذف الرسالة أول شي
        ...
        allRows.forEach((row) => {
          ...
          const spanSent = statusCell?.querySelector("span");

          let showRow = false;

          if (value === "finished") {
            showRow =
              spanSent && spanSent.textContent.trim().toLowerCase() === "sent";
          } else if (value === "not") {
            showRow = !!checkbox;
          } else {
            showRow = true;
      ...
      <td colspan="8" style="text-align:center;">
        There are no ${value} customized orders currently!!!
      </td>
    `;
          ordersTable.appendChild(noRow);
        }
      }
