...
<html lang="en">
  <head>
    ...
    <script
      nomodule
      src="https://unpkg.com/ionicons@7.2.1/dist/ionicons/ionicons.js"
    ></script>
  ...
  <body>
    <div class="page d-flex">
      ...
      <div class="content w-full">
        ...
        <div class="wrapper images-gallery m-20">
          <div class="header">
            <a href="{{ route('list-product')}}" class="back-btn">
              <i class="fas fa-arrow-circle-left"></i>
            </a>
            <div class="layout">
              <div class="grid active" id="grid">
                <!-- <i class="icon fa-solid fas fa-th-large"></i> --><ion-icon
                  name="grid"
                  class="icon"
                ></ion-icon>
              </div>
    ...
    <script>
      ...
      //   layoutControl
      const galleryHolder = document.querySelector(".boxes");
      const layoutHolder = document.querySelector(".layout");
      const layoutControllers = Array.from(layoutHolder.children);
      layoutHolder.addEventListener("click", (e) => {
        if (
          ...
          layoutControllers.forEach((controller) => {
            ...
            if (controller.classList.contains("active")) {
              ...
              if (controller.classList.contains("grid")) {
                galleryHolder.style.gridTemplateColumns =
                  "repeat(auto-fill, minmax(400px, 1fr))";
              }
              if (controller.classList.contains("rows")) {
                galleryHolder.style.gridTemplateColumns = "1fr";
              }
            }
          });
        }
