...
<html lang="en">
  ...
  --error-color: #b3261e;
    ...
    rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px; */
      ...
      .control-products form {
        width: 50%;
      }
      .control-products form > div {
        margin-bottom: 24px;
        display: flex;
        flex-direction: column;
        gap: 4px;
      ...
      .control-products form input::placeholder {
        color: #a6a6a6;
      }
      .control-products form input:focus,
      .control-products form select {
        outline: none;
      }
  ...
  <body>
      ...
      <div class="content w-full">
        ...
        <div class="wrapper">
          <div class="control-products content">
            <div class="holder">
              <form method="POST" action="{{ route('set-delivery' ,['id' => $order_item->id])}}">
                @csrf
                <div class="name">
                  <label for="delivery_id">Select Delivery:</label>
                  <select name="delivery_id" id="delivery_id">
                    @foreach ( $deliveres as $delivery )
                    <option value="{{ $delivery->id }}">{{ $delivery->email }}</option>
                    @endforeach
                  </select>
                </div>
    ...
    <script>
      ...
      //   handle submit
      /* const submitBtn = document.querySelector("form input.btn");
      const selectedDelivery = document.querySelector("form select ");
      const form = document.querySelector("form");
      form.addEventListener("submit", (e) => {
        e.preventDefault();
        window.location.href = `shop.html${window.location.search}&delivery=${selectedDelivery.value}`;
      }); */
    </script>
  </body>
</html>
